...
if __name__ == '__main__':
    ...
    parser.add_argument('--games-path', help='Path to games', default="/home/agniv/Documents/RL/RECORD_ATTEMPY")
    parser.add_argument('--record', action='store_true', help='Whether to record video or not', default=True)
    ...
    parser.add_argument('--output-path', default="/home/agniv/Documents/RL/", help='Where to save video')
