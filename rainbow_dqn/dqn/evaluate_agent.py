...
parser.add_argument('--filename', help='Path to the pretrained model', default='RNBW_EVEN_CMPLX_OPPS_NOISY_50000.pkl')
...
if __name__ == '__main__':
    ...
    opponent = h_env.BasicOpponent(weak=False) #change the opponent here
    evaluate(agent=q_agent, env=env, current_mode='normal', opponent=opponent, eval_episodes=opts.eval_episodes,
             action_mapping=q_agent.action_mapping, evaluate_on_opposite_side=True)
