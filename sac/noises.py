# The pink-noise-rl library was unstable (in terms of some of the requirements and input dimensions) so some of the code was copied and modified here.
...
# ColoredNoiseProcess and PinkNoiseProcess for general use
...
from pink import SquashedDiagGaussianDistribution
